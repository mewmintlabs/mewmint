...
class MewmintGuiInit : public MewmintInit
{
public:
    MewmintGuiInit(const std::string& arg_chain_type) : MewmintInit(arg_chain_type) {}
...
int main(int argc, char* argv[])
{
    ...
    std::unique_ptr<init::MewmintGuiInit> app_init = std::make_unique<init::MewmintGuiInit>(init::NetworkToString(gArgs.GetChainType()));
